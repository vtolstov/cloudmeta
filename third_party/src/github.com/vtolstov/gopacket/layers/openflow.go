...
// Copyright 2014-2015 Vasiliy Tolstov. All rights reserved.
//
...
var LayerTypeOpenflow = gopacket.RegisterLayerType(12340, gopacket.LayerTypeMetadata{"Openflow", gopacket.DecodeFunc(decodeOFP)})
...
// OFP is the layer for OFP headers.
...
func (o *Openflow) DecodeFromBytes(data []byte, df gopacket.DecodeFeedback) error {
	...
	case o.Length >= 8:
		...
		o.Payload = data[8:hlen]
	default:
		return fmt.Errorf("OFP packet too small: %d bytes", o.Length)
	}
	return nil
}
...
func (o *Openflow) NextLayerType() gopacket.LayerType {
	switch o.Version {
	//	case 0x04:
	//		return LayerTypeOpenflow13
	//	case 0x01:
	//		return LayerTypeOpenflow10
	default:
...
/*
func (o *OFP) TransportFlow() gopacket.Flow {
